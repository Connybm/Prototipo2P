...
{
    public partial class Frm_Mant_Puesto : Form

    {
        Logica logic = new Logica();
        string scampo;
        public Frm_Mant_Puesto()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader ejectuar = logic.modificarPuesto(Txt_Cod.Text, Txt_nombre.Text, txt_Estatus.Text);
        ...
        {
            OdbcDataReader cita = logic.InsertarPuesto(Txt_Cod.Text, Txt_nombre.Text, txt_Estatus.Text);
