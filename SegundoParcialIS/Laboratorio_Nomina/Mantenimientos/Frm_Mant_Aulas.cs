...
{
    public partial class Frm_Mant_Aulas : Form
    {
        Logica logic = new Logica();
        string scampo;
        public Frm_Mant_Aulas()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader ejectuar = logic.ModificarAulas(Txt_Cod.Text, Txt_nombre.Text, txt_Estatus.Text);
        ...
        {
            OdbcDataReader cita = logic.InsertarAulas(Txt_Cod.Text, Txt_nombre.Text, txt_Estatus.Text);
        ...
        {
            OdbcDataReader cita = logic.eliminarAulas(Txt_Cod.Text);
        ...
        {
            Consulta_Aulas puesto = new Consulta_Aulas();
            puesto.ShowDialog();
